...
-- Service users
CREATE ROLE auth_service WITH LOGIN PASSWORD '2210Ngahoang.@';
CREATE ROLE order_service WITH LOGIN PASSWORD '2210Ngahoang.@';
CREATE ROLE inventory_service WITH LOGIN PASSWORD '2210Ngahoang.@';
CREATE ROLE payment_service WITH LOGIN PASSWORD '2210Ngahoang.@';
CREATE ROLE notification_service WITH LOGIN PASSWORD '2210Ngahoang.@';
