package com.nqh.paymentservice.common.handler;
...
import com.nqh.paymentservice.common.response.ValidationError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<BaseResponse<Void>> handleUnhandledException(HttpServletRequest request) {
        String traceId = request.getHeader(TRACE_HEADER);
        BaseResponse<Void> response = BaseResponse.error(
