...
public enum MessageCode {
    ...
    INVENTORY_REVIEW_CREATE_SUCCESS("INVENTORY_REVIEW_CREATE_SUCCESS", "Product review created successfully"),
    INVENTORY_REVIEW_UPDATE_SUCCESS("INVENTORY_REVIEW_UPDATE_SUCCESS", "Product review updated successfully"),
    INVENTORY_REVIEW_COMMENT_CREATE_SUCCESS("INVENTORY_REVIEW_COMMENT_CREATE_SUCCESS", "Product review comment created successfully"),
    ...
    INVENTORY_PRODUCT_IMAGE_REQUIRED("INVENTORY_PRODUCT_IMAGE_REQUIRED", "Product image file is required"),
    INVENTORY_PRODUCT_IMAGE_UPLOAD_FAILED("INVENTORY_PRODUCT_IMAGE_UPLOAD_FAILED", "Product image upload failed"),
    INVENTORY_PRODUCT_IMAGE_STORAGE_NOT_CONFIGURED("INVENTORY_PRODUCT_IMAGE_STORAGE_NOT_CONFIGURED", "Product image storage is not configured"),
    ...
    INVENTORY_REVIEW_NOT_FOUND("INVENTORY_REVIEW_NOT_FOUND", "Product review not found"),
    INVENTORY_REVIEW_ALREADY_EXISTS("INVENTORY_REVIEW_ALREADY_EXISTS", "You already reviewed this product"),
    INVENTORY_REVIEW_FORBIDDEN("INVENTORY_REVIEW_FORBIDDEN", "You cannot modify this review"),
